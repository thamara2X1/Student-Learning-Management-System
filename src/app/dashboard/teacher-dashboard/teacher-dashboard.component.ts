      ...
      <div class="dashboard-content">
        <div class="welcome-section">
          <div class="welcome-card main-card">
            ...
            <p>Manage your courses, track student progress, and engage with your students all in one place.</p>
          ...
          <div class="info-card">
            ...
            <div class="info-grid">
              ...
              <div class="info-item">
                ...
                <span class="role-badge teacher">{{ authService.currentUser()?.role }}</span>
              </div>
              <div class="info-item">
          ...
          <div class="status-card">
            ...
            <ul class="coming-soon-list">
              ...
              <li>✏️ Assignment builder with rubrics</li>
